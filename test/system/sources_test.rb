...
class SourcesTest < ApplicationSystemTestCase
  ...
  test "should create source" do
    ...
    check "Active" if @source.active
    fill_in "Etag", with: @source.etag
    fill_in "Last error status", with: @source.last_error_status
    fill_in "Last modified", with: @source.last_modified
    fill_in "Name", with: @source.name
    check "Show images" if @source.show_images
