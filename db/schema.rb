...
ActiveRecord::Schema[8.0].define(version: 2026_01_03_120707) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.index "(((to_tsvector('simple'::regconfig, COALESCE((title)::text, ''::text)) || to_tsvector('simple'::regconfig, COALESCE((source_name)::text, ''::text))) || to_tsvector('simple'::regconfig, COALESCE(searchable_content, ''::text))))", name: "index_articles_on_searchable_fields", using: :gin
