...
const u = "https://huggingface.co/diffusionstudio/piper-voices/resolve/main",
  ...
  if (e.match("https://huggingface.co"))
    try {
      const o = await (
        ...
        ).getDirectoryHandle("piper", {
          create: !0,
        }),
        a = e.split("/").at(-1),
        t = await (await o.getFileHandle(a, { create: !0 })).createWritable();
...
async function S(e, m) {
  ...
  const n = await fetch(e),
    o = (r = n.body) == null ? void 0 : r.getReader(),
    a = +(n.headers.get("Content-Length") ?? 0);
  let i = 0,
    t = [];
  for (; o; ) {
...
function b(e, m, n) {
  const o = e.length,
    a = 44,
    i = new DataView(new ArrayBuffer(o * m * 2 + a));
  i.setUint32(0, 1179011410, !0),
    i.setUint32(4, i.buffer.byteLength - 8, !0),
    i.setUint32(8, 1163280727, !0),
    i.setUint32(12, 544501094, !0),
    i.setUint32(16, 16, !0),
    i.setUint16(20, 1, !0),
    i.setUint16(22, m, !0),
    i.setUint32(24, n, !0),
    i.setUint32(28, m * 2 * n, !0),
    i.setUint16(32, m * 2, !0),
    i.setUint16(34, 16, !0),
    i.setUint32(36, 1635017060, !0),
    i.setUint32(40, 2 * o, !0);
  let t = a;
  for (let r = 0; r < o; r++) {
    const s = e[r];
    s >= 1
      ? i.setInt16(t, 32767, !0)
      : s <= -1
      ? i.setInt16(t, -32768, !0)
      : i.setInt16(t, (s * 32768) | 0, !0),
      (t += 2);
  }
  return i.buffer;
}
...
async function N(e, m) {
  ...
  const a = await f(`${u}/${n}.json`),
    ...
    r = 0,
    s = i.audio.sample_rate,
    d = i.inference.noise_scale,
    g = i.inference.length_scale,
    U = i.inference.noise_w,
    k = await f(`${u}/${n}`, m),
  ...
  Object.keys(i.speaker_id_map).length &&
    Object.assign(w, { sid: new _.Tensor("int64", [r]) });
  const {
    output: { data: E },
  } = await y.run(w);
...
async function P() {
  ...
  if (!e.ok) throw new Error("Could not retrieve voices file from huggingface");
