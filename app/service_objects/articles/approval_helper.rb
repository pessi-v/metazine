...
module Articles
  class ApprovalHelper
    ...
    def approve?
      ...
      if html_string.nil? || html_string&.length < 1900 # filters some cases where no article is shown without Javascript or cookies, and some cases of actually Video/Podcast content
        return false
